...
✅ **Done:** `zadani01`, `zadani02`, `zadani03`, `zadani05`, `zadani06`

❌ **Todo:** `zadani04`, `zadani07`, `zadani08`, `zadani09`, `zadani10`, `zadani11`
...
### todo: 
```
exec, string operation, makefile, shared memory, named semaphores, http, (htons, ntohs), stat
```
